...
public class EncryptUtil {
   ...
   // public static String key = "LmMGStGtOpF4xNyvYt54EQ==";  
	public static String key = "Y3Jvd2Rpc25ld25ld2lzYw==";
...
//    	byte[] b="crowdisnewnewisc".getBytes("UTF-8");
//    	String str=Base64.byteArrayToBase64(b);
//    	
//    	System.out.println(str);
//    	String str=EncryptUtil.encrypt("我是中国人啊");
//    	System.out.println("============"+str);
//    	String str2=EncryptUtil.decrypt(str);
//    	System.out.println("============"+str2);
    	
    	String str=EncryptUtil.encrypt("1");
    	System.out.println("============"+str);
    }  
}  
