  ...
  font-size: 80%;
	 ...
	 <div class="form-group  col-md-12">
		...
		<div id="headUpload" class="bh-l-inline bi-icon-container uploadPosition pointed">
			 <img  src="<%=request.getContextPath()%>/statics/images/bg-header.jpg" id="headImg" class="headImg" />
		</div>
...
<div class="form-group col-md-12" >
	  <label class="col-sm-2 control-label" style="font-size: 14px;">是否接受推荐</label>
	<div class="col-sm-10">
