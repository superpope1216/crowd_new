...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<select class="form-control myinput" id="gzlbdm" multiple="multiple" data-bv-notempty="true" 
...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<select class="form-control myinput" id="scjsdm" multiple="multiple" data-bv-notempty="true" 
				data-fv-notempty-message="此项不能为空">
...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<textarea class="form-control myinput" name="gzjl" placeholder="请输入工作经历" ></textarea>
	</div>
</div>
<div class="form-group col-md-12">
	<label class="col-sm-2 control-label" style="font-size: 14px;">项目经验</label>
	<div class="col-sm-10">
		<textarea class="form-control myinput" name="xmjy" placeholder="请输入项目经验"></textarea>
	</div>
</div>
<div class="form-group col-md-12">
	<label class="col-sm-2 control-label" style="font-size: 14px;">作品展示链接</label>
	<div class="col-sm-10">
		<input class="form-control myinput" name="zslj" placeholder="请输入作品展示链接" >
	</div>
</div>
<div class="form-group col-md-12">
