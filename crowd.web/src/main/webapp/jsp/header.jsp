...
<!-- 						<li class="nav-li   margin-left-0"><a
				...
				<div class="nav-hover">
					...
					<ul>
						...
						<li><a href="http://crowd.campusphere.cn/portal/myCourseIndex/1.mooc" target="_blank" title="在线视频">在线视频</a></li>
					...
					<ul>
						...
						<li><a
							href="<%=request.getContextPath() %>/zckfz/index" title="操作手册">操作手册</a></li>
						<li><a
