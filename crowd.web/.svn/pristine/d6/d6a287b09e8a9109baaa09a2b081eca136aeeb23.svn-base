...
<body>
								...
								<table class="table table-striped m-b-0 mytable">
									...
									<tbody>
										<tr>
											...
											<td class="text-xs-left"><span class="tag tag-default"><a
													target="_blank"
													href="<%=request.getContextPath() %>/rwxxDetail/index?rwid=${rwjbxx.wid}">${rwjbxx.rwbh}</a></span>
											</td>
											<td class="text-xs-left"><span class="tag tag-default"><a
													target="_blank"
													href="<%=request.getContextPath() %>/rwxxDetail/index?rwid=${rwjbxx.wid}">${rwjbxx.rwmc}</a></span></td>
											...
											<c:choose>
												<c:when test="${sfxysh==true}">
													<tr>
														...
														<td><span class="tag tag-default">￥ <fmt:formatNumber
																	type="number"
																	value="${ysje}"
	...
	<div class="modal fade modal-primary in" id="modal_sqys"
		...
		<div class="modal-dialog modal-center">
			<div class="modal-content" >
				<div class="modal-header">
					...
					<h4 class="modal-title">申请验收</h4>
				</div>
				<div class="modal-body">
					<form id="formSqys" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-2 control-lable">评价：</label>
							<div class="col-sm-10">
								<div data-option="pj" class="block clearfix" name="pj">
						...
						<div class=" form-group">
							...
							<div class="col-sm-10">
								<textarea rows="3" class="form-control" name="tgpjnr" required
									data-fv-notempty-message="此项不能为空">${content}</textarea>
							</div>
						</div>
					</form>
				</div>
	...
	<div class="modal fade modal-primary in" id="modalPj"
		aria-labelledby="moadl_ysxx" role="dialog" tabindex="-1">
		<div class="modal-dialog modal-center">
			<div class="modal-content" >
				<div class="modal-header">
