...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<select class="form-control myinput" name="gzlbdm" >
...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<select class="form-control myinput" name="scjsdm" >
...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<select class="form-control myinput" name="gznx">
			<option value="">---请选择擅长的技术---</option>
...
<div class="form-group col-md-12">
	...
	<div class="col-sm-10">
		<select class="form-control myinput" name="gzxz" >
