						...
						<div class="panel-body  shop-order">
							<div class="row">
								<div class="col-xs-12 gzzx-header">平台须知</div>
									<div class="col-xs-12 gzzx-subheader">第一种方式 注册为需求方</div>
								<div class="col-xs-12 gzxx-content">
									...
									<p>3、然后选择注册为身份为 需求方</p>
									<p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/register_xqf01.png" class="col-xs-12"/>
									
									<p>4、选择需求方注册的用户类型(个人或者企业  选择后对应的身份认证页面不同) 点击注册</p>
									...
									<p>6、注册成功之后进入完善基本信息,填写必填的选项(上传头像,昵称,常住省,QQ,支付宝账号,邮箱),点击保存并继续按钮</p>
									<p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/register_xqf_basic01.png" class="col-xs-12"/>
									<p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/register_xqf_basic02.png" class="col-xs-12"/>
									<p>7、进入完善身份认证  这里以个人身份认证为例,填写必填项,身份证正反面附件按照参考案例上传,点击提交审核,信息提交完成后,系统会自动进入个人基本信息页面</p>
                                    <p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/register_xqf_card01.png" class="col-xs-12"/>
                                    <p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/register_xqf_card02.png" class="col-xs-12"/>
                                    
								</div>
								<div class="col-xs-12 gzzx-subheader">第二种方式  成为需求方</div>
								<div class="col-xs-12 gzxx-content">
									<p>1、用户如果以需求方身份注册,可以通过其它入口成为需求方</p>
									<p>2、点击首页的需求方中心,点击自由职业之路,如果你不是需求方  系统会提示并跳转成为需求方页面</p>
								    <p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/become_xqf01.png" class="col-xs-12"/>
									
									<p>3、用户还可以点击 首页页面  我想投标,如果你不是需求方  系统会提示并跳转成为需求方页面</p>
									<p><img src="<%=request.getContextPath()%>/statics/images/operation/yhgl/become_xqf02.png" class="col-xs-12"/>
