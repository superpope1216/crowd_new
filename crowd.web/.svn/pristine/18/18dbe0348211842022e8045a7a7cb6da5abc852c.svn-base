...
<%-- 		<a class="dropdown-item <%=setActive(menuFlag, "wgcljz")%>"
		...
		<a class="dropdown-item <%=setActive(menuFlag, "xyzgz")%>"
			href="<%=request.getContextPath()%>/xyzgz/index?flag=xyzgz">信誉值管理须知</a>
...
<div class="panel row m-b-0 m-r-15 hidden-md-down" boxmh-h>
	<div class="panel-body">
		...
		<ul class="list-group m-l-15 met-sidebar-nav">
			...
			<li class="list-group-item <%=setActive(menuFlag, "xyzgz")%>"><a
				href="<%=request.getContextPath()%>/xyzgz/index?flag=xyzgz">信誉值管理须知</a></li>
