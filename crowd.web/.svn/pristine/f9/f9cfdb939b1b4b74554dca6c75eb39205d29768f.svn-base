...
<div class="cardInfo">
	 ...
	 <div class="form-group col-md-12">
		...
		<div class="col-sm-10">
			<select class="form-control myinput" name="userRange"  data-bv-notempty="true" 
	...
	<div class="form-group col-md-12">
		<label class="col-sm-2 control-label" style="font-size: 14px;">法定代表人姓名</label>
		<div class="col-sm-10">
			<input type="text" class="form-control myinput" name="xm"
				placeholder="请输入法定代表人姓名" data-bv-notempty="true" 
			   data-fv-notempty-message="此项不能为空" >
		</div>

	</div>
	<div class="form-group col-md-12">
		<label class="col-sm-2 control-label" style="font-size: 14px;">法定代表人身份证号</label>
		<div class="col-sm-10">
			<input type="text" class="form-control myinput" name="sfzjh"
				placeholder="法定代表人身份证号"  data-bv-notempty="true" 
			   data-fv-notempty-message="此项不能为空" 
			   data-bv-regexp="true" 
	...
	<div class="form-group  met-upfile">
		<label class="col-sm-2 control-label" style="font-size: 14px;">法定代表人身份证正面扫描件(500kb以内)</label>
	...
	<div class="form-group  met-upfile">
		<label class="col-sm-2 control-label" style="font-size: 14px;">法定代表人身份证反面扫描件(500kb以内)</label>
		<div class="col-sm-10" style="padding-bottom: 10px;">
